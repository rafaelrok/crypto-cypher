...
public class JwtResponse {
    ...
    public JwtResponse(String token, Long id, String username, String email, List<String> roles, boolean isFirstAccess) {
        this.token = token;
        this.id = id;
    ...
    public ResponseCookie getTokenCookie() {
        return tokenCookie;
    }

    public void setTokenCookie(ResponseCookie tokenCookie) {
